      ...
      <AdminLayout>
        ...
        <div className="flex px-5 justify-center items-center h-[90vh] gap-4">
          <div className="w-4/5 bg-gray-50 h-full ">
            <div className="relative p-5 h-48 bg-[#5D5FEF] rounded-3xl flex flex-col justify-between text-white">
              <div className="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-6/12 lg:max-w-full lg:absolute xl:px-0 filter brightness-50">
                ...
                <img
                  className="object-cover w-full h-56  shadow-lg  lg:shadow-none md:h-96 lg:h-full rounded-3xl"
              ...
              <div className="relative ">
                ...
                <div className="flex gap-4 justify-between">
                  ...
                  <button className="bg-white bg-opacity-20 backdrop-blur-sm flex gap-2 items-center px-5 py-2 rounded-lg w-1/8">
                    <FiFilter size={25} />
                    Filter
                  </button>
                  <button className="bg-white bg-opacity-20 backdrop-blur-sm flex gap-2 items-center px-5 py-2 rounded-lg w-1/8">
                  ...
                  <button className="bg-white bg-opacity-20 backdrop-blur-sm px-5 py-2 rounded-lg w-1/20">
                    <FiPrinter size={25} />
                  </button>
                </div>
              </div>
            ...
            <div className=" px-5 py-2 my-2 rounded-xl bg-gray-100">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 text-gray-600 font-semibold">
                  ...
                  <button className=" px-5 py-2 rounded-lg">2</button>
                  <button className="px-5 py-2 rounded-lg">3</button>
                  <button className="px-5 py-2 rounded-lg">. . .</button>
                  <button className="px-5 py-2 rounded-lg">38</button>
                  <button className="px-5 py-2 rounded-lg">Next</button>
                </div>
              </div>
            </div>
            <div className="h-8"></div>
          </div>
          <div className="w-1/5  bg-gray-50 h-full pr-4 ">
            <div className="bg-[#5D5FEF] h-64 p-5 rounded-3xl flex flex-col justify-between relative">
              <div>
                <h1 className="text-2xl">See analytics of</h1>
                <h1 className="text-2xl">the Customer</h1>
                <h1 className="text-2xl">Clearly</h1>
              </div>
              <button className="bg-white z-50 bg-opacity-20 backdrop-blur-sm flex gap-2 items-center justify-center py-4 rounded-lg w-32 ">
                See Analitycs
              </button>
            ...
            <div className=" bg-gray-100 mt-6 rounded-3xl  text-gray-800">
                <div className="py-5 px-4">

              <div className="text-2xl font-semibold">Top Menu</div>
              <div className="text-2xl font-semibold text-[#F17300]">
                This Week
              </div>
              <div className="text-sm py-5">10 - 12 Agustus 2023</div>
              <div className="relative">
                <div className="px-4 py-4 bg-white shadow-md font-semibold text-sm rounded-lg  transform rotate-1">
              ...
              <div className="text-sm py-4">2. Tongseng Sapi Gurih</div>
              <div className="text-sm py-4">3. Nasi Gudeg Telur Ceker</div>
              <div className="text-sm py-4">4. Nasi Ayam serundeng</div>
              <div className="text-sm py-4">5. Nasi Goreng Seafood</div>
                </div>
              <div className="">
                <Image src="/graph.png" className="w-full" width={300} height={300} />
              </div>
            </div>
          </div>
        </div>
